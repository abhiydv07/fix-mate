...
export function MobileNav() {
  ...
  return (
    <nav aria-label="Main navigation" className="fixed bottom-0 left-0 right-0 z-50 bg-slate-950/95 backdrop-blur-lg border-t border-slate-800/80 px-4 py-2 max-w-md mx-auto flex items-center justify-around md:hidden">
      {navItems.map((item) => {
