...
export function Footer() {
  return (
    <footer className="mt-12 bg-slate-950 border-t border-slate-900 px-4 md:px-8 py-8 text-slate-400">
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          {/* Customer Trust */}
          <div className="space-y-2">
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-200">Trust & Security</h4>
            <ul className="space-y-1.5 text-xs">
