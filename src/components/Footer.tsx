...
export function Footer() {
  return (
    <footer className="mt-12 bg-slate-100 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-900 px-4 md:px-8 py-8 text-slate-500 dark:text-slate-400">
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-bold text-base text-slate-900 dark:text-white">Fix Mate</span>
            </div>
          ...
          <div className="space-y-2">
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-200">Services</h4>
          ...
          {/* Customer Trust */}
          <div className="space-y-2">
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-200">Trust & Security</h4>
            <ul className="space-y-1.5 text-xs">
          ...
          {/* Contact & Support */}
          <div className="space-y-2">
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-200">Support</h4>
            <ul className="space-y-1.5 text-xs">
        ...
        <div className="pt-6 border-t border-slate-200 dark:border-slate-900 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-2">
